...
/***/ "../node_modules/css-loader/index.js!../node_modules/sass-loader/lib/loader.js!../node_modules/postcss-loader/index.js!../node_modules/less-loader/dist/index.js!./view/userMirror/MirrorItem/index.scss":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".mirror-item {\n  display: table-cell;\n  text-align: center;\n  border: 5px solid #ccc;\n  border-right: 0; }\n\n.mirror-item .mirror-item-title {\n  line-height: 32px;\n  font-size: 14px;\n  border-bottom: 5px solid #ccc; }\n\n.mirror-item .mirror-item-chart {\n  padding: 0 10px; }\n\n.mirror-item:last-child {\n  border-right: 5px solid #ccc; }\n", ""]);
...
/***/ "../node_modules/css-loader/index.js!../node_modules/sass-loader/lib/loader.js!../node_modules/postcss-loader/index.js!../node_modules/less-loader/dist/index.js!./view/userMirror/index.scss":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".user-mirror-container {\n  padding: 10px;\n  display: table; }\n\n.user-mirror-container .user-mirror-title {\n  display: table-header-group;\n  line-height: 32px;\n  font-size: 16px; }\n", ""]);
...
/***/ "../node_modules/g2-react/lib/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _g = __webpack_require__("../node_modules/g2/index.js");
...
var _g2React = __webpack_require__("../node_modules/g2-react/lib/index.js");
...
var TreeChart = function (_React$Component) {
    ...
    function TreeChart(props, context) {
        _classCallCheck(this, TreeChart);

        var _this = _possibleConstructorReturn(this, (TreeChart.__proto__ || Object.getPrototypeOf(TreeChart)).call(this, props, context));
    ...
    _createClass(TreeChart, [{
        key: 'getChildrenDeep',
        value: function getChildrenDeep(list) {
            var _this2 = this;

            var arr = list.map(function (obj) {
                if (obj.children) {
                    return 1 + _this2.getChildrenDeep(obj.children);
                } else {
                    return 1;
                }
            });
        ...
        key: 'renderTree',
        value: function renderTree(nodes, edges, dx, chart) {
            chart.clear();
            var Stat = _g2.default.Stat;
            var height = Math.max(100, 40 / dx); // 最小高度 500
            var deep = nodes.length ? this.getChildrenDeep(nodes) : 1;
            ...
            edgeView.edge().position(Stat.link('source*target', nodes)).shape('smooth').color('#ccc');
            function strLen(str) {
                var len = 0;
                for (var i = 0; i < str.length; i++) {
        ...
        key: 'drawNode',
        value: function drawNode(cfg, group, collapsed, isLeaf) {
            var x = cfg.x;
            var y = cfg.y;
            var pointSize = 5;
            var width = cfg.size;
        ...
        key: 'getTreeChart',
        value: function getTreeChart() {
            var _this3 = this;

            return (0, _g2React2.default)(function (chart) {
                _g2.default.Shape.registShape('point', 'collapsed', {
                    drawShape: function drawShape(cfg, group) {
                        return _this3.drawNode(cfg, group, true);
                    }
                });

                _g2.default.Shape.registShape('point', 'expanded', {
                    drawShape: function drawShape(cfg, group) {
                        return _this3.drawNode(cfg, group, false);
                    }
                });

                _g2.default.Shape.registShape('point', 'leaf', {
                    drawShape: function drawShape(cfg, group) {
                        return _this3.drawNode(cfg, group, false, true);
                    }
                });

                var data = chart.get('data').data,
                    Stat = _g2.default.Stat;
                // 使用layout，用户可以自己编写自己的layout
                // 仅约定输出的节点 存在 id,x，y字段即可
                var layout = new _g2.default.Layout.Tree({
                    nodes: data
                });
                var dx = layout.dx,
                ...
                _this3.renderTree(nodes, edges, dx, chart);
...
/***/ "./view/userMirror/MirrorItem/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _treeChart = __webpack_require__("./components/treeChart/index.js");

var _treeChart2 = _interopRequireDefault(_treeChart);

__webpack_require__("./view/userMirror/MirrorItem/index.scss");
...
var MirrorItem = function (_React$Component) {
    _inherits(MirrorItem, _React$Component);

    function MirrorItem(props, context) {
        _classCallCheck(this, MirrorItem);

        return _possibleConstructorReturn(this, (MirrorItem.__proto__ || Object.getPrototypeOf(MirrorItem)).call(this, props, context));
    }

    _createClass(MirrorItem, [{
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'mirror-item-title' },
                    title
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'mirror-item-chart' },
                    _react2.default.createElement(_treeChart2.default, { data: list })
                )
            );
        }
    }]);
...
exports.default = MirrorItem;

/***/ }),

/***/ "./view/userMirror/MirrorItem/index.scss":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("../node_modules/css-loader/index.js!../node_modules/sass-loader/lib/loader.js!../node_modules/postcss-loader/index.js!../node_modules/less-loader/dist/index.js!./view/userMirror/MirrorItem/index.scss");
if(typeof content === 'string') content = [[module.i, content, '']];
// add the styles to the DOM
var update = __webpack_require__("../node_modules/style-loader/addStyles.js")(content, {});
if(content.locals) module.exports = content.locals;
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("../node_modules/css-loader/index.js!../node_modules/sass-loader/lib/loader.js!../node_modules/postcss-loader/index.js!../node_modules/less-loader/dist/index.js!./view/userMirror/MirrorItem/index.scss", function() {
			var newContent = __webpack_require__("../node_modules/css-loader/index.js!../node_modules/sass-loader/lib/loader.js!../node_modules/postcss-loader/index.js!../node_modules/less-loader/dist/index.js!./view/userMirror/MirrorItem/index.scss");
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
...
var _MirrorItem = __webpack_require__("./view/userMirror/MirrorItem/index.js");

var _MirrorItem2 = _interopRequireDefault(_MirrorItem);

var _actions = __webpack_require__("./view/userMirror/reducer/actions.js");

__webpack_require__("./view/userMirror/index.scss");
...
var UserMirror = function (_React$Component) {
    _inherits(UserMirror, _React$Component);

    function UserMirror(props, context) {
        _classCallCheck(this, UserMirror);

        return _possibleConstructorReturn(this, (UserMirror.__proto__ || Object.getPrototypeOf(UserMirror)).call(this, props, context));
    }

    _createClass(UserMirror, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'user-mirror-container' },
                _react2.default.createElement(
                    'div',
                    { className: 'user-mirror-title' },
                    '\u7528\u6237\u6807\u7B7E: ',
                    this.props.username
                ),
                this.props.data.map(function (obj, key) {
                    return _react2.default.createElement(_MirrorItem2.default, { key: key, data: obj });
                })
            );
        }
    }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return (0, _redux.bindActionCreators)({ getUserMirror: _actions.getUserMirror }, dispatch);
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(UserMirror);

/***/ }),

/***/ "./view/userMirror/index.scss":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("../node_modules/css-loader/index.js!../node_modules/sass-loader/lib/loader.js!../node_modules/postcss-loader/index.js!../node_modules/less-loader/dist/index.js!./view/userMirror/index.scss");
if(typeof content === 'string') content = [[module.i, content, '']];
// add the styles to the DOM
var update = __webpack_require__("../node_modules/style-loader/addStyles.js")(content, {});
if(content.locals) module.exports = content.locals;
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("../node_modules/css-loader/index.js!../node_modules/sass-loader/lib/loader.js!../node_modules/postcss-loader/index.js!../node_modules/less-loader/dist/index.js!./view/userMirror/index.scss", function() {
			var newContent = __webpack_require__("../node_modules/css-loader/index.js!../node_modules/sass-loader/lib/loader.js!../node_modules/postcss-loader/index.js!../node_modules/less-loader/dist/index.js!./view/userMirror/index.scss");
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
...
/***/ "./view/userMirror/reducer/actions.js":
/***/ (function(module, exports, __webpack_require__) {
...
exports.getUserMirror = undefined;
...
var getUserMirror = exports.getUserMirror = function getUserMirror() {
...
//# sourceMappingURL=userMirror.e72a6b2fa94de58f891e.chunk.js.map